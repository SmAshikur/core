...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Products'], function () {
            ...
            // assessment
            Route::resource('/assessment', 'Back\AssessmentTestController', ['as' => 'back', 'except' => 'show']);
            Route::resource('/assessment_category', 'Back\AssessmentCategoryController', ['as' => 'back', 'except' => 'show']);
        ...
        //----------------Course------------
        Route::resource('/course','Back\CourseController',['as'=>'back']);
        Route::get('/order','Back\CourseController@getOrder')->name('back.order.index');
        Route::get('/order/{id}/{status}','Back\CourseController@corseOrderStatus')->name('back.corse_order.status');
    });
...
Route::group(['middleware' => 'maintainance'], function () {
   ...
   return "ok" ;
        ...
        Route::prefix('user')->group(function () {
            ...
            //----------- TEST-------------
            Route::get('/test','User\TestController@index')->name('user.test.index');
            Route::post('/test/store','User\TestController@storeFirst')->name('user.test.store.first');
        });
        ...
        Route::get('courses/{item}','Front\FrontendController@teachersTraning')->name('courses');
        Route::get('/single-course/{slug}','Front\FrontendController@singleCourse')->name('single-course');
        Route::post('/course-order','Front\FrontendController@courseOrder')->name('course_order');
        //----------------__--------------
        ...
        Route::get('children-skills','Front\AssismentController@childrenSkills')->name('children_skills');
        Route::post('children-skills','Front\AssismentController@childrenSkillsStore')->name('children_skills.store');
        Route::get('/result-children','Front\AssismentController@resultChildren')->name('result.children');
        //------------ PAGE ------------
