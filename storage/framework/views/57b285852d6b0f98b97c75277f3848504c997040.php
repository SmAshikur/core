...
<?php $__env->startSection('content'); ?>
 ...
 <!-- Page Header Start -->
  ...
  <div class="container pt-3 pb-3">
    <div class="row pb-4">
        <div class="col-md-12">
            <form action="<?php echo e(route("children_skills.store")); ?>" method="post" class="col-md-12 border card shadow">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/therapylabonline/public_html/core/resources/views/front/assisment/children_skills.blade.php ENDPATH**/ ?>