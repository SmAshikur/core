			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.assessment.store')); ?>" method="POST"
									...
									<div class="form-group">
										<label for="cat_id"><?php echo e(__('Select Category')); ?> *</label>
									...
									<div class="form-group">
										...
										<input type="text" name="question" class="form-control item-name" id="question"
											placeholder="Enter question" value="<?php echo e(old('question')); ?>" >
									</div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\demo\bs\well-known\core\resources\views/back/tests/assessment/create.blade.php ENDPATH**/ ?>