...
<?php $__env->startSection('content'); ?>
 ...
 <!-- Page Header Start -->
    <div class="page-header container-fluid bg-primary d-flex flex-column align-items-center justify-content-center">
        <h1 class="display-3 text-uppercase mb-3"><?php echo e(optional($item)->title); ?></h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="m-0 px-3">/</h6>
            <h6 class="text-uppercase m-0"><?php echo e(optional($item)->slug); ?></h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="row pb-4">
        <div class="col-lg-8 col-md-8 col-12">
            <div class="card mb-4 faq-box">
                ...
                <div class="card-body">
                    <h4 class="card-title"><?php echo e(optional($item)->title); ?></h4>
                    <small><b>Price : </b> $<?php echo e(optional($item)->price); ?> <i><?php echo e(optional($item)->time); ?></i></small><br/>
                    <p class="card-text"><?php echo optional($item)->description; ?></p>
                </div>
        ...
        <div class="col-md-4 col-12 col-lg-4">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('course_order')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                      <div class="form-group">
                        <label for="name">Your Name</label>
                        <input type="text" name="name" required class="form-control" id="name" placeholder="Input Your Name">
                        <input type="hidden" required name="course_id" class="form-control" value="<?php echo e($item->id); ?>" id="name" placeholder="Input Your Name">
                      </div>
                      <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/therapylabonline/public_html/core/resources/views/front/course/single_course.blade.php ENDPATH**/ ?>