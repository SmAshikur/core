...
<li class="nav-item">
    ...
    <div class="collapse" id="itemss">
        <ul class="nav nav-collapse">
            <li>
                <a class="sub-link" href="{{ route('back.assessment_category.index') }}">
                    <span class="sub-item">Assesment Category Index</span>
                </a>
            </li>
            <li>
                <a class="sub-link" href="{{ route('back.assessment.index') }}">
    ...
    <li class="nav-item">
        ...
        <div class="collapse" id="course">
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="{{ route('back.course.index') }}">
                      <span class="sub-item">{{ __('Create Course') }}</span></a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('back.order.index') }}">
                      <span class="sub-item">{{ __('All Order') }}</span></a>
                </li>
            </ul>
        </div>
    </li>
